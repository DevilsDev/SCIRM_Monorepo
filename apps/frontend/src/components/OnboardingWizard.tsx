    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full mx-4 overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4">
          ...
          {step === 1 && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Welcome to SCIRM</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-4">Select your industry to get tailored risk insights</p>
          ...
          {step === 2 && (
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Quick Tour</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-4">Here's what you can do with SCIRM</p>
              <div className="space-y-3">
                {[
                  { title: 'Run Risk Assessments', desc: 'AI agents analyze suppliers across 7 risk dimensions' },
                  { title: 'Track Suppliers', desc: 'Monitor risk scores, discover sub-tier suppliers' },
                  { title: 'Simulate Disruptions', desc: 'Monte Carlo digital twin for what-if scenarios' },
                  { title: 'Get Real-time Alerts', desc: 'Auto-generated alerts when risks cross thresholds' },
                ].map((item, i) => (
          ...
          {step === 3 && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Start by running your first risk assessment or exploring the dashboard.</p>
            </div>
          )}
        </div>
        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 flex justify-between">
          {step > 1 ? (
            ...
            <button onClick={handleFinish} className="px-4 py-2 text-sm text-gray-400 hover:text-gray-600">Skip</button>
          )}
          {step < 3 ? (
            <button
