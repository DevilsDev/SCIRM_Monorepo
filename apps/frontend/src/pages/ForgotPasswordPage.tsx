        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">If an account exists for <strong>{email}</strong>, you'll receive a password reset email shortly.</p>
              <Link to="/login" className="inline-block mt-4 text-sm text-blue-600 hover:text-blue-800 font-medium">Back to Sign In</Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                <Link to="/login" className="text-blue-600 hover:text-blue-800 font-medium">Back to Sign In</Link>
              </p>
            </form>
          )}
        </div>
