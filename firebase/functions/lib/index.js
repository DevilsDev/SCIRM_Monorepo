 ...
 */
async function handleAuthCallback(req, res, requestId) {
    if (req.method !== "POST") {
 ...
 * Serve documentation files from Cloud Storage
 */
async function serveDocumentationFile(req, res, requestId, userClaims) {
 ...
 */
async function streamFile(file, res, requestId) {
    try {
